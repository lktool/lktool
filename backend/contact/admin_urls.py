...
from .admin_views import AdminSubmissionsView, AdminSubmissionDetailView, AdminReplyView, AdminProcessedSubmissionsView
...
urlpatterns = [
    ...
    path('processed/<int:submission_id>/', AdminProcessedSubmissionsView.as_view(), name='admin_delete_submission'),
]
